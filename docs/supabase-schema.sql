-- =============================================================================
-- Schema Supabase – Sistema Timbrature (da OpenAPI)
-- Eseguire in Supabase SQL Editor su un database vuoto o dopo aver verificato
-- che enums/tabelle non esistano già. Per aggiornamenti incrementali commentare
...
-- Ruoli (opzionale; utile per permessi espandibili)
...
-- Storico cambi ruolo (RoleHistory)
...
-- Sessioni refresh (auth rotation)
...
-- Storico rigenerazioni QR (QRCodeRevision)
...
-- Revisioni timbrature (TimbraturaRevision)
...
-- -----------------------------------------------------------------------------
-- 3. VISTA TURNI (coppie IN/OUT consecutive)
-- -----------------------------------------------------------------------------
